...
public class ProductCatalogController {
	...
	JsonObject publishEvent(@RequestBody EventoQuery query) throws Exception{
	...
	JsonObject createFormaPagoEvento(@RequestBody FormaPagoEvento formaPagoEvento) throws Exception{
	...
	JsonObject updateFormaPagoEvento(@RequestBody FormaPagoEvento formaPagoEvento) throws Exception{
	...
	JsonObject setStatusFormaPagoEvento(@RequestBody FormaPagoEventoQuery query) throws Exception{
